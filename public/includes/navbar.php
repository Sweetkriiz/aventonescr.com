        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="dropdownMenu">
            ...
            <?php if ($rol === 'Chofer'): ?>
              ...
              <li>
                <h6 class="dropdown-header">Panel de Chofer</h6>
              </li>
            ...
            <?php if ($rol === 'Pasajero'): ?>
              ...
              <li>
                <h6 class="dropdown-header">Panel de Pasajero</h6>
              </li>
              <li><a class="dropdown-item" href="/dashboard_pasajero.php"><i class="bi bi-car-front me-1"></i> Panel de Pasajero</a></li>
            <?php endif; ?>
            ...
            <?php if ($rol === 'Administrador'): ?>
              ...
              <!-- Gestión interna -->
              <li><a class="dropdown-item" href="/dashboard_admin.php"><i class="bi bi-tools me-1"></i> Panel de Administración</a></li>

              <li>
                <hr class="dropdown-divider">
              </li>
              <li>
                <h6 class="dropdown-header">Paneles de Vista</h6>
              </li>
              <li><a class="dropdown-item" href="/dashboard_chofer.php"><i class="bi bi-speedometer2 me-1"></i> Panel de Chofer</a></li>
              <li><a class="dropdown-item" href="/dashboard_pasajero.php"><i class="bi bi-car-front me-1"></i> Panel de Pasajero</a></li>
            <?php endif; ?>
